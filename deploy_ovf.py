    ...
    if path.exists(ovf_path):
        with open(ovf_path, 'r') as f:
            try:
                ...
                print ("Could not read file: " , ovf_path)
                exit(1)
...
def get_objects(si, args):
    ...
    if args.datastore_name:
        ...
        print ("No datastores found in DC " , datacenter_obj.name)
    ...
    if args.cluster_name:
        ...
        print ("No clusters found in DC " , datacenter_obj.name)
...
def main():
    ...
    try:
        ...
        print ("Unable to connect to ", args.host)
        exit(1)
